...
struct gdt_entry gdt[GDT_SIZE] = {
	...
	[GDT_KERNEL_CODE_INDEX] =
		GDT_ENTRY(GDT_FLAGS_LONG_MODE,
				  GDT_ACCESS_KERNEL | GDT_ACCESS_CODE_DATA_SEG | GDT_ACCESS_CODE | GDT_ACCESS_RW),
	[GDT_KERNEL_DATA_INDEX] = GDT_ENTRY(0, GDT_ACCESS_KERNEL | GDT_ACCESS_CODE_DATA_SEG |
											   GDT_ACCESS_DATA | GDT_ACCESS_RW),
	[GDT_USER_CODE_INDEX] =
		GDT_ENTRY(GDT_FLAGS_LONG_MODE,
				  GDT_ACCESS_USER | GDT_ACCESS_CODE_DATA_SEG | GDT_ACCESS_CODE | GDT_ACCESS_RW),
	[GDT_USER_DATA_INDEX] =
		GDT_ENTRY(0, GDT_ACCESS_USER | GDT_ACCESS_CODE_DATA_SEG | GDT_ACCESS_DATA | GDT_ACCESS_RW)};
...
void gdt_init_tss(void)
{
	...
	gdt_tss_entry->access =
		GDT_ACCESS_KERNEL | GDT_ACCESS_PRESENT | GDT_ACCESS_SYSTEM_SEG | GDT_ACCESS_TSS;
